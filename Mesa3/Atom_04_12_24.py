...
velocidad=120#velocidad original 100
#constante de proporcion
kp=12.5#kp original 12
#constante integral
ki=0.1
    ...
    if -1<distance<48: 
        ...
        if -1<distance_sensor.distance()<50: #confirmo si sigo detectando 
            ...
            while color_sensor_r.reflection() > centro_negro:
                mover_motores_indefinido(375,100) #giro con direccion derecha hasta encontrar el centro de la linea con el sensor izquierdo
            parar_motores()
            ...
            while color_sensor_f.reflection() > cenntro_negro_frente:
                mover_motores_indefinido(-100,100) # giro hacia hasta encontrar el centro de la linea con el sensor del frente para alinearme a la linea
            parar_motores()
...
def rescate():
    ...
    if orientacion == "izquierda":#debo realizar el recorrido girando hacia la izquierda
        ...
        wait(500)
        if distance_sensor.distance()  < 740:
            wait(100)
            print(distance_sensor.distance())
            #recorrido corto-largo
            bajar()
            while True:
                ...
                wait(10)
                hub.imu.reset_heading(0) #reinicio el giroscopio
                recorrer_distancia(900,0,300) #hacer el recorrido largo (120 cm)
                ...
                parar_motores()
                hub.imu.reset_heading(0)
                recorrer_distancia(600,0,300)#hacer el recorrido corto (90cm)
                esquina=3 #si la esquina es igual a 3 me preparo para hacer el recorrido Largo-Corto y vuelvo en diagonal
                break
            ...
            movermotores(-900,-900,1)
            movermotores(300,300,1.1)#avanza para meter el corralito en el negro
            subir()
            wait(1500)
            #retrocede
            movermotores(-600,-600,1)
            ...
            motor_izquierdo.stop()
            movermotores(300,300,0.5)#avanza para acercarme a la tercera pared
            bajar()
            wait(1500)
            ...
            if esquina == 2: #hago recorrido corto-largo
                hub.imu.reset_heading(0)#resetea giroscopo
                recorrer_distancia(330,0,300)#avanza 45cm corto
