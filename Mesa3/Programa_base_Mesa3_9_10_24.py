...
def rescate():
    ...
    movermotores(100,100,1) #avanzo un poco para entrar a la zona de rescate
    ...
    if orientacion == "izquierda":#debo realizar el recorrido girando hacia la izquierda
        ...
        if (color_sensor_l.color() == Color.BLACK or 
         ...
         color_sensor_f.color() == Color.BLACK):
            pass
            """aqui deberia programar el corralito y dejar las victimas si encontre"""
